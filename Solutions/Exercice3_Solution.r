...
if (nom_premier_fruit == nom_deuxieme_fruit) {
  print("premier fruit est le même que le deuxieme fruit")
} else {
  paste(nom_premier_fruit, "n'est pas une", nom_deuxieme_fruit)
}
##################################################################
...
if (nb_premier_fruit > nb_deuxieme_fruit) {
  paste("Il y a trop de", nom_premier_fruit)
} else if (nb_premier_fruit < nb_deuxieme_fruit) {
  paste("Il y a trop de", nom_deuxieme_fruit)
} else {
...
if (nb_premier_fruit > nb_deuxieme_fruit) {
  message <- paste("Il y a trop de", nom_premier_fruit)
  if (nom_premier_fruit == "banane") {
    message <- paste0(message, ", mais c'est correct :)")
  }
  print(message)
} else if (nb_premier_fruit < nb_deuxieme_fruit) {
  message <- paste("Il y a trop de", nom_deuxieme_fruit)
  if (nom_deuxieme_fruit == "banane") {
    message <- paste0(message, ", mais c'est correct :)")
  }
  print(message)
} else {
...
if (nb_premier_fruit <= 3 && nb_deuxieme_fruit <= 3) {
  print("Les portions sont bonnes!")
} else {
...
premiere_portion_valide <- (nom_premier_fruit == "banane" || nb_premier_fruit <= 3)
deuxieme_portion_valide <- (nom_deuxieme_fruit == "banane" || nb_deuxieme_fruit <= 3)

if (premiere_portion_valide && deuxieme_portion_valide) {
  print("Les portions sont bonnes!")
} else {
  print("C'est trop pour une seule personne")
}
...
if ((nom_premier_fruit == "pomme" && nb_premier_fruit == 2) || nb_premier_fruit == 4) {
  print("Miam!")
} else if (nom_premier_fruit == "tomate") {
